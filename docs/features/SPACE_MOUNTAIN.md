...
- compile-time `BAKING_MODE` is false;
...
Subsystem-local development preview switches exist for simulator tuning, but they are diagnostic
APIs rather than a player-facing or release command surface.
